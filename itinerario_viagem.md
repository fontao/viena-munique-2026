...
> partir do Dia 3 à noite é que o grupo é de **7**.

---

## 🚨 Prazos Críticos — Tratar Já
...
- **Marcar a visita para as 14:00** de sábado 26 — **não para as 13:30** (ver Dia 4). O Ticket
  Center recomenda estar em Hohenschwangau **90 a 120 minutos antes** da hora de entrada, e
  com o despertar às 10:00 só as 14:00 dão essa margem.
...
vales que se bebem e comem. Divididos por 7 dá ~€60 a €79 cada.
...
| Jantar de sábado em Augsburg, Dia 4 — **21:15** | 7 | reserva grátis | reservar de manhã |
| **Contacto de táxi/van de 7+ lugares em Munique** (Dia 6) | 7 | — | ver Dia 6 |
...
| **Palácio de Nymphenburg** | 7 | Parque **grátis** · palácio **€10**/pax · *Gesamtkarte* **€20** | Ver Dia 7: só há 75 min |
| **Alter Peter** (torre, Munique) | 7 | €5/pax = €35 | Dia 6 · segunda 09:00–18:30 · 306 degraus |
| **St. Jakobskirche** (Rothenburg) | 7 | €5/pax = €35 | Dia 5 · altar de Riemenschneider |
...
**Hackerbrücke**, que é a paragem da Wiesn. Máximo 5 pessoas por bilhete — daí serem 2.
...
- ❌ **"U2 cortado entre Schottentor e Karlsplatz" — FALSO.** A U2 **voltou a circular
  ...
  *Mas o trajeto do Dia 2 não muda*: de Karlsplatz para Praterstern, a **U1 são 4 estações**
  (Stephansplatz, Schwedenplatz, Nestroyplatz) e a **U2 são 7**, porque dá a volta ao Ring.
...
- **14:45 – 18:00**: Passeio a pé pelos monumentos imperiais, **numa linha reta para poente,
  ...
  - **14:55** — **Ankeruhr** (*Hoher Markt*), a 150 m. Relógio mecânico *Jugendstil* de 1914
    numa ponte suspensa entre dois edifícios. Grátis, 5 min. **Ao meio-dia desfilam as 12
    figuras com música** — a esta hora vê-se só uma, mas fica a saber-se para o Dia 3.
...
- **17:00 – 19:45**: **Wiener Prater** — e este ano com um bónus que ninguém tinha visto.
  ...
  - **17:30 – 18:15**: **Riesenrad** (**€14,50** — o bilhete de €17 é o *Flex*, com validade de
    um ano, que não precisam). Setembro: aberta até às 23:45.
...
- **16:35 – 17:15**: **Táxi pré-reservado** da estação de Augsburg até à **Enterprise
  ...
  - ⏱️ **Contar 30 a 40 minutos no balcão, não 15.** Levantar uma carrinha grande implica
    papelada, seguro e volta de inspeção de danos — em balcões pequenos isto demora. A versão
    anterior do roteiro dava 15 minutos e era otimista.
...
- **17:45 – 18:25**: **Fuggerei** — *Fuggerei 56*, **€8/pessoa**, aberta **todos os dias das
...
- **18:25 – 18:40**: **Damenhof**, no *Fuggerhäuser* (*Maximilianstraße 36–38*), a 350 m e
  literalmente no caminho para o jantar. Pátio de arcadas construído por Jakob Fugger em 1515,
  considerado o claustro renascentista florentino mais refinado a norte dos Alpes.
  **Acesso livre e gratuito**, 10 minutos.
...
- **20:15 – 21:30**: **Passeio noturno, grátis.** O sol põe-se às ~19:05, portanto a cidade já
  ...
  **Maximilianstraße**, a avenida renascentista com o *Merkurbrunnen* e o *Herkulesbrunnen* ➔
  ...
  apartamento.
  - ⛪ **Se ainda for antes das 19:00** — ou seja, se jantarem mais tarde — vale o desvio de
...
> **O roteiro dava 85 minutos entre a chegada a Hohenschwangau e a entrada no castelo.**
> O Ticket Center oficial recomenda expressamente estar na aldeia **90 a 120 minutos antes**
> da hora de entrada — levantamento obrigatório dos bilhetes, fila, e depois a subida.
> 85 minutos ficava **abaixo do mínimo oficial**, num sábado de época alta, com um bilhete de
> hora marcada e não reembolsável de €164,50.
> **A correção é marcar a visita para as 14:00 e inverter a ordem da tarde.**
...
- **12:05 – 14:00**: **115 minutos de margem — é isto que faz o dia funcionar.**
  Levantamento dos bilhetes no **Ticket Center**, subida ao castelo e travessia da
  **Ponte Marienbrücke** sobre a garganta do Pöllat, que é onde se tiram as fotografias.
  ...
  - 🚌 **Usar o shuttle (10 min), não subir a pé.** A subida a pé são **40 minutos** de rampa e
    não cabe nesta margem. Carruagem a cavalos: €8 a subir, €4 a descer.
...
- **15:30 – 16:35**: Condução até **Oberammergau** pela **B17 / B23**, via Steingaden
  (~60 km, ~1h05). **Tudo em estrada alemã.**
- **16:35 – 17:35**: **Aldeia de Oberammergau** com **sol alto** — fachadas pintadas com
  frescos tradicionais (*Lüftlmalerei*), a Pilatushaus, o artesanato em madeira.
  - 🏛️ A **Abadia de Ettal** fica 4 km adiante, na mesma estrada. **Não está no plano como
    visita** — é a primeira coisa a cortar se o dia derrapar. Se estiverem à tabela, uma
    paragem de 10 minutos para ver a cúpula barroca pelo exterior vale a pena, e a loja dos
    monges vende as cervejas do mosteiro.
...
- **18:10 – 19:15**: **Lago Eibsee ao pôr do sol**, aos pés da **Zugspitze** (2.962 m, ponto
  ...
  refletido na água.
  - ⚠️ **Não se faz a volta ao lago.** O *Eibsee-Rundweg* tem **7,5 km e demora ~2 horas** — o
    roteiro anterior prometia "a volta pelas margens" em 75 minutos e isso é impossível.
    **O que se faz:** do parque de estacionamento (a 100 m da margem) caminha-se pelo trilho
    ...
    com a melhor vista sobre a Zugspitze. Depois, cerveja sentados no **Biergarten am See**,
    junto ao *seeRestaurant Eibsee Pavillon*, à beira de água.
  - 🅿️ Estacionamento **€9 a €10** até 4 horas.
- **19:15 – 21:05**: Regresso a Augsburg via Garmisch (**~140 km, ~1h50**). **Jantar às 21:15.**
  - ⚠️ **Reservar o jantar de sábado de manhã, antes de sair.** Sábado à noite em plena época
    de Oktoberfest, um grupo de 7 sem mesa não se senta em lado nenhum decente. **Reservar para
    as 21:15**, não para as 20:45.
...
> frescos no escuro. **Invertendo a ordem** — Oberammergau às 16:35 com sol, Eibsee às 18:10 ao
...
>
> **O custo de tudo isto:** jantar às 21:15 em vez das 20:45. É o preço mais barato de toda
> esta revisão.
>
> **Se preferirem jantar mais cedo:** sair de Augsburg às 09:45 (despertar às 08:30) e manter a
> entrada nas 13:30 — tudo acontece 30 minutos antes e jantam às 20:45. Foi o que dois dos três
...
- **12:50 – 17:30**: Visita à jóia medieval **Rothenburg ob der Tauber**: caminhada pelas
  ...
  - 🖼️ **A coisa que faltava aqui, e que os três analistas apontaram em uníssono: a
    St. Jakobskirche** (*Klostergasse 15*, 200 m da Marktplatz). **€5/pessoa, aberta ao
    domingo das 10:00 às 18:00.** No piso superior está o **Altar do Sangue Sagrado**,
    entalhado em tília por **Tilman Riemenschneider entre 1500 e 1505** — é um dos maiores
    tesouros da escultura sacra alemã e é, com alguma probabilidade, a melhor coisa que há
    em Rothenburg. **~14:45 – 15:15.**
  - 🌄 **Burggarten** (400 m da Marktplatz, grátis, aberto sempre): o promontório onde estava o
    castelo imperial dos Hohenstaufen, com a panorâmica mais desafogada sobre o vale do Tauber,
    os socalcos de vinha e a ponte medieval de arcos duplos. **~13:45 – 14:10.**
  - 🗡️ *Opcional, pago:* **Mittelalterliches Kriminalmuseum** (*Burggasse 3–5*, €9, domingo
    10:00–18:00, última entrada 17:15). Mil anos de história do direito penal, com máscaras de
    vergonha e instrumentos originais. Só se preferirem isto a mais tempo nas muralhas —
    substitui, não soma.
...
- **14:45 – 15:45**: **Odeonsplatz** e a **Theatinerkirche** de fachada amarela — fica
  literalmente no caminho, sem desvio nenhum — depois **Hofgarten** e a **Eisbachwelle**, os
...
- **22:45 – 22:58**: Chegar a München Hbf, ver o cais nos monitores e **apanhar o RE9 nº 57088**.
  Chegada a Augsburg Hbf às **23:46**. O Bayern-Ticket é válido até às 03:00.

**Se falharem as 22:58:**
1. **Táxi ou van — é este o plano B a sério.** Munique ➔ Augsburg são ~65 km pela A8,
   45–50 min, **€150 a €180**, o que dividido por 7 dá **€22 a €26 por pessoa**.
   ⚠️ **Combinar o contacto de um táxi de 7+ lugares em Munique ANTES de sair da tenda.** Não
   é razoável contar com arranjar uma van de sete lugares à meia-noite de uma noite de
...
**⏰ Acordar 10:00 — depois da noite de Oktoberfest, vai fazer falta.**
...
- **12:00 – 13:15**: **Palácio e Jardins de Nymphenburg** (zona Oeste): caminhada ao longo do
  ...
  - 🎟️ **Não comprem o bilhete combinado.** A *Gesamtkarte* de verão custa **€20/pax** (não os
    ...
    de Porcelana — são **2 a 3 horas** e vocês têm **75 minutos**. Com este tempo: ou **só o
...
- [ ] **Hora de check-in** do Central City Apartments (Dia 1) e de **check-out** (Dia 3).
- [ ] **Hora de check-out** do Lexapartments (Dia 7).
- [ ] 🔴 **Classe da carrinha — por escrito, não no balcão.** Um monovolume normal de 7 lugares
      (Alhambra, Sharan, Galaxy) tem **200 a 300 litros de mala** com a 3.ª fila levantada:
      não leva 4 malas de porão + 4 de cabine + 7 mochilas. É preciso a categoria
      **van / minibus de 9 lugares** (VW Transporter ou Caravelle, Mercedes Vito, Ford Tourneo
      Custom), que dá 580 a 720 litros. **Exigir confirmação escrita à Enterprise de Augsburg
      antes de partir** — se entregarem a categoria errada na sexta, o problema começa logo no
      Dia 4, não só no último dia.
...
- [ ] 🔴 **Contacto de um táxi/van de 7+ lugares em Munique**, guardado no telemóvel antes do
...
- [ ] **Mesas reservadas:** Schweizerhaus (Dia 2 — **crítica, é o dia de abertura da Kaiser
      Wiesn ali ao lado**), Das Loft (Dia 2), Bauerntanz (Dia 3), jantar de sábado às **21:15**
      (Dia 4).
...
2. **Alojamento Alemanha (25 a 29 Set.) — 7 pessoas:**
   - *Lexapartments Zentral 101m²* — Am Bogen 6 (R/C), 86152 Augsburg, Alemanha
   - 17 min a pé da estação central de Augsburg

3. **Aluguer de Viatura:**
   - *Enterprise Rent-A-Car Augsburg* — Aindlinger Str. 14 · **+49 821 448360**
   - Horário: **Sexta 08:00–18:00 · Sábado 09:00–12:00**
   - Levantamento 25 Set · Devolução 29 Set no MUC (Mietwagenzentrum, Terminal 2) · **€440,01**
